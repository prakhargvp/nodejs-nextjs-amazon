...
export default function Search(props) {
  ...
  const filterSearch = ({
    ...
    if (max) query.max = query.min ? query.max : query.max === 0 ? 0 : max;
          ...
          <Grid item md={9}>
            <Grid container justifyContent="space-between" alignItems="center">
              <Grid item>
                ...
                {category !== 'all' && query !== '' && ' : ' + category}
                {brand !== 'all' && query !== '' && ' : ' + brand}
                {price !== 'all' && query !== '' && ' : ' + price}
                {rating !== 'all' && query !== '' && ' : ' + rating}
                {(query !== 'all' && query !== '') ||
                category !== 'all' ||
                brand !== 'all' ||
                rating !== 'all' ||
            ...
            <Pagination
              ...
              defaultPages={parseInt(query.page || '1')}
              count={pages}
